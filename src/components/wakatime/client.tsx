...
interface WakapiStatsDisplayProps {
  initialData: WakaTimeStats | null;
}

export function WakapiStatsDisplay({ initialData }: WakapiStatsDisplayProps) {
  const [stats, setStats] = useState<WakaTimeStats | null>(initialData);
  ...
  useEffect(() => {
    const fetchStats = async () => {
      ...
      try {
        ...
        console.error("Error fetching Wakapi stats:", err);
    ...
    // Start periodic updates after initial render (every hour since it's weekly data)
