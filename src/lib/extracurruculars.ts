...
export async function getExtracurriculars(): Promise<Extracurricular[]> {
    return [
        ...
        },
        {
            ...
            description: "Take point in organizing workshops, tech talks, and collaborations with other organizations to foster a supportive community for underrepresented students in tech. Developed and maintained our organization's website with Next.js and Tailwind CSS, led technical workshops, mentored over 50 students, and collaborated on events with sponsors.",
        },
        {
