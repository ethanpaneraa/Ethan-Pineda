                ...
                <div className="mt-5 w-full flex flex-col md:flex-row justify-center items-center md:items-start text-md">
                    <div className="w-full md:max-w-lg lg:max-w-2xl mb-6 md:mb-0 md:pr-4 lg:pr-8">
                        <p className="mb-4">I am currently a third-year at
                            ...
                            <strong className="text-orange">Computer Science</strong> with minors in <strong className="text-orange">Data Science</strong> and <strong className="text-orange">Latino/Latina Studies</strong>.
                        </p>
                        <p className="mb-4">
                            After my studies, I hope to work as a <strong className="text-orange">Full-Stack Software Engineer</strong> with a focus on building scalable, performant, and user-friendly applications.
                        </p>
                        <p className="mb-4">
                            At Northwestern, I&apos;ve had the privilege of working with various research groups and professors, I also serve on the executive board of multiple different student organizations that are aimed at enhancing diversity and inclusion in tech, and interned at amazing companies, including <a className="text-orange">Salesforce</a>, where I was a Software Engineer Intern and will be returning to for the summer of 2024!
                        </p>
                    ...
                    <div className="flex justify-center lg:pl-10 mb-6 md:mb-0">
                        <img src="/me.jpg" className="max-w-xs md:max-w-18 h-auto rounded-lg shadow-lg border-none hover:translate-y-[-7px] transition duration-300"/>
                    </div>
                </div>
            </FadeInSection>
        </div>
