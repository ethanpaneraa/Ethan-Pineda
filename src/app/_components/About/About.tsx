            ...
            <FadeInSection delay={100}>
                ...
                <div className="mt-5 w-full flex flex-col md:flex-row justify-center items-center md:items-start text-md">
                    <div className="w-full mb-6 md:mb-0 md:pr-4 lg:pr-8">
                        <p className="mb-4">I am currently a third-year at {" "}<a href="https://www.northwestern.edu/about/" target="_blank" className="text-orange font-semibold underline">
                                {" "}Northwestern University
                            </a>
                            {" "}where I am pursuing my Bachelors of Arts in {""}
                            <a href="https://www.mccormick.northwestern.edu/computer-science/" target="_blank"><strong className="text-orange">Computer Science</strong></a>{" "}with minors in <a href="https://statistics.northwestern.edu/undergraduate/data_science_minor/minoring_data_science.html" target="_blank"><strong className="text-orange font-semibold">Data Science</strong></a>{" "} and <a href="https://latinostudies.northwestern.edu/undergraduate/majors-minors.html" target="_blank"><strong className="text-orange font-semibold">Latino/Latina Studies</strong></a>.{
                        ...
                        <p className="mb-4">
                            At Northwestern, I&apos;ve had the privilege of working with various research groups and professors, I also serve on the executive board of multiple different student organizations that are aimed at enhancing diversity and inclusion in tech, and interned at amazing companies, including <a  href="https://www.salesforce.com/products/data/" target="_blank" className="text-orange font-semibold">Salesforce</a>, where I was a Software Engineer Intern and will be returning to for the summer of 2024!
                        </p>
