    ...
    const myExtracurriculars: Array<ExtracurricularObject> = [
        {
            ...
            description: "As the Webmaster, I developed and maintained the site with Next.js and Tailwind CSS, led technical workshops, mentored over 50 students, and collaborated on events with sponsors.",
        },
        {
            ...
            description: "Directed the mentorship program for 75 Latinx engineering majors, boosting participation by 30% and organizing senior panels to enhance career readiness.",
        },
        {
            ...
            description: "As Founder and Treasurer, secured over $3,000 in funding and managed finances with a focus on corporate sponsorships to support our initiatives.",
        },
        {
