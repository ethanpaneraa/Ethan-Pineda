...
export default function Extracurriculars() {
    ...
    return (
        <>
            <div className="flex flex-col items-center justify-center text-paragraph-gray px-4 sm:px-6 lg:px-8 max-w-screen-xl mx-auto">
                        ...
                        {myExtracurriculars.map((activity, index) => (
                            <li key={index} className="mb-10 ml-4 w-md">
                                ...
                                <div className="w-full">
                                    ...
                                    <h3 className="text-2xl font-bold text-paragraph-gray dark:text-paragraph-gray">{activity.organization}</h3>
                                    <h4 className="mb-1 text-lg font-semibold text-paragraph-gray dark:text-paragraph-gray">{activity.position}</h4>
