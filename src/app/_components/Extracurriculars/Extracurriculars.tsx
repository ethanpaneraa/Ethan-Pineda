...
export default function Extracurriculars() {
  const myExtracurriculars: Array<ExtracurricularObject> = [
    ...
    },
    {
      ...
      position: "Founding Exectuive Board & Vice President",
    ...
    {
      organization: "Emerging Coders",
      position: "Founding Exectuive Board & Webmaster",
  ...
  return (
    <>
      <div
        id="organizations"
        className="flex flex-col items-center justify-center  text-paragraph-gray px-4 sm:px-6 lg:px-8 mx-auto mb-10 md:py-36"
      >
                ...
                <li key={index} className="mb-10 flex">
                  ...
                  <div className="flex-shrink-0  flex-col w-1/3 md:w-1/4 text-left md:text-right text-md font-normal text-paragraph-gray pr-4">
                    ...
                    <div className="flex flex-col text-sm">
                      <time className="text-left md:text-right mb-2">
                        {org.duration}
                      </time>
                  ...
                  <div className="relative flex-grow border-l border-dashed border-bg-gray pl-4">
                    ...
                    <div className="pl-4">
                      ...
                      <h4 className="mb-1 text-lg font-medium text-paragraph-gray">
                        {org.position}
                      </h4>
                      <p className="text-base font-normal text-paragraph-gray">
                        {org.description}
                      </p>
                    </div>
                  </div>
